...
/* ------------------- 1° noticia -------------- */
$not1img = '../images/jogos1.png'; //imagem
$not1link ='noticia1.php'; //link da noticia

/* ------------------- 2° noticia -------------- */
$not2img = '../images/jogos2.jpg'; //imagem
$not2link ='noticia2.php'; //link da noticia

/* ------------------- 3° noticia -------------- */
$not3img = '../images/jogos3.jpg'; //imagem
...
/* ------------------- 6° noticia -------------- */
$not6img = '../images/jogos6.jpg'; //imagem
$not6link ='noticia6.php'; //link da noticia

/* ------------------- 7° noticia -------------- */
$not7img = '../images/jogos7.jpg'; //imagem
...
/* ------------------- 10° noticia -------------- */
$not10img = '../images/jogos10.jpg'; //imagem
$not10link ='noticia10.php'; //link da noticia

/* ------------------- 11° noticia -------------- */
$not11img = '../images/jogos11.jpg'; //imagem
