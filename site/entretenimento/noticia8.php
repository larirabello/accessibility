...
$idioma = new idiomas();
$idioma = $idioma->BuscaIdioma('entretenimento', 'not8');
...
$not2textlink = 'noticia2.php'; // Link da noticia

// 3° noticia
$not3link = '../entretenimento'; //Link do tema
$not3textlink = 'noticia3.php'; // Link da noticia
