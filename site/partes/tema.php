  ...
  <li class="active">'.$temaName.'</li>
    ...
    <div class="thumbnail size280">
                <a href="'.$not7link.'">
                        ...
                        <img src="'.$not7img.'" class="img-responsive text-cente img-7" alt="'.$not7alt.'">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 news">
                    <div class="thumbnail size123b">
                        <img src="'.$not10img.'" class="img-responsive pull-right img-2b" alt="'.$not10alt.'">
                        <div class="caption">
                            <p>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 news">
                <div class="thumbnail size123b">
                    <img src="'.$not11img.'" class="img-responsive pull-right img-2b" alt="'.$not11alt.'">
                    <div class="caption">
                        <p>
